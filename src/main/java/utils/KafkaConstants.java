...
public class KafkaConstants {
    ...
    public static final String KAFKA_QUERY_1_WEEKLY_TOPIC = "kafka-streams-query1-weekly";
    public static final String KAFKA_QUERY_1_MONTHLY_TOPIC = "kafka-streams-query1-monthly";
    public static final String KAFKA_QUERY_2_WEEKLY_TOPIC = "kafka-streams-query2-weekly";
    public static final String KAFKA_QUERY_2_MONTHLY_TOPIC = "kafka-streams-query2-monthly";

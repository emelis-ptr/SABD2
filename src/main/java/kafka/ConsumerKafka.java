...
public class ConsumerKafka implements Runnable {
    ...
    private Consumer<String, String> createConsumer() {
        Properties props = KafkaProperties.getKafkaParametricConsumerProperties(CONSUMER_GROUP_ID);
     ...
     */
    public ConsumerKafka(int id, String topic, boolean flink, @Nullable String path) {
        this.flink = flink;
        if (flink) {
